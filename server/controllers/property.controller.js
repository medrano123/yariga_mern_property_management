...
const getPropertyDetail = async (req, res) => {
    ...
    if(propertyExists) {
        ...
        res.status(404).json({ messege: 'Property not found' })
...
const createProperty = async (req, res) => {
    try {
        ...
        // start a new session creates an automic session
        ...
        res.status(200).json({ messege: 'Property has been succesfully created'})    
